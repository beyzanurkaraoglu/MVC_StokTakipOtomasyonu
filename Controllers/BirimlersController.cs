...
{
    public class BirimlersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Birim,Açıklama")] Birimler birimler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Birim,Açıklama")] Birimler birimler)
        {
            if (ModelState.IsValid)
            {
